...
* make sure the order service is running.
...
// Powershell
curl  --data-binary '{"customer_id":"101021","payment_method":{"card_type":"VISA","expiration": "01/22","name":"John Doe","billing_address":"201, 1st Street, San Jose, CA"}, "items":[{"code":"101","qty":1},{"code":"103","qty":5}],"shipping_address": "201, 1st Street, San Jose, CA"}' -H @{ "content-type" = "application/json"} http://localhost:8080/order
```